...
gii_add <- mutate(gii, rpfm = Edu2.FM, rlfm = Labo.FM)
str(gii_add)
...
library(stringr)
human$GNI <- strtoi(human$GNI, base=0L)
...
# 5. Define the row names by the country names 

# 5. remove the country name column from the data.